...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Upsert profile in RTDB (non-blocking)
      ...
      >
        <div className="glass-panel rounded-lg p-8 cyber-border">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-bold font-mono text-gradient">Login</h1>
              <p className="text-muted-foreground text-xs">Access your encrypted vault</p>
            </div>
          </div>
